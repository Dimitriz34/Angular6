...
export const EMAIL_MESSAGES = {
  TP_SERVICES_DETECTED: 'TP Internal app detected - email configuration is automatically managed, no credentials required',
...
export const APPLICATION_LABELS = {
  SMTP_PROVIDERS: [
    { value: 'External', label: 'External Providers' },
