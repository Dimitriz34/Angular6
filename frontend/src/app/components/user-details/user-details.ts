...
export class UserDetailsComponent implements OnInit {
  ...
  selectUser(user: User) {
    ...
    this.selectedNewStatus = user.active;
  ...
  async onClickUpdateRole(): Promise<void> {
    ...
    try {
      ...
      if (this.selectedNewStatus !== this.selectedUserForRole.active) {
        await firstValueFrom(this.userService.approveUser(this.selectedUserForRole.userId, this.selectedNewStatus));
      }
